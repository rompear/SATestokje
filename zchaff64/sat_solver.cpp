...
//following lines will print out a solution if a solution exist
    ...
    // 
    // 
    cout << SAT_Random_Seed(mng) << endl;
    cout << SAT_MaxDLevel(mng) << endl;
    cout << SAT_NumDecisions(mng)<< endl;
    cout << SAT_NumDecisionsStackConf(mng);
    cout << " + " <<SAT_NumDecisionsVsids(mng)<<" + "<<SAT_NumDecisionsShrinking(mng)<<endl;
    cout << SAT_NumVariables(mng) << endl;
    cout << SAT_InitNumClauses(mng) << endl;
    cout << SAT_InitNumLiterals(mng) << endl;
    cout << SAT_NumAddedClauses(mng)- SAT_InitNumClauses(mng)<< endl;
    cout << SAT_NumShrinkings(mng)<< endl;
    cout << SAT_NumDeletedClauses(mng)-SAT_NumDelOrigCls(mng) <<endl;
    cout << SAT_NumDeletedClauses(mng) <<endl;
    cout << SAT_NumAddedLiterals(mng) - SAT_InitNumLiterals(mng) << endl;
    cout << SAT_NumDeletedLiterals(mng) <<endl;
    cout << SAT_NumImplications(mng)<< endl;
    //other statistics comes here
    cout << SAT_GetCPUTime(mng) << endl;
